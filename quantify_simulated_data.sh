...
#srun --time=01-00:00:00 --account=cbcb --qos=huge-long --nodes=1 --ntasks=1 --partition=cbcb --mem=5000 bash -c "hostname; echo \"Processing sample 1 of 2 in ${samp} with EM\"; ./bin/salmon quant -i transcriptome/human_index -l IU -1 ${fn}/${samp}/sample_01_1_shuffled.fa.gz -2 ${fn}/${samp}/sample_01_2_shuffled.fa.gz -p 6 --gcBias --useBoth --validateMappings -o quants/${samp}_01_quant_both"&
srun --time=01-00:00:00 --account=cbcb --qos=huge-long --nodes=1 --ntasks=1 --partition=cbcb --mem=5000 bash -c "hostname; echo \"Processing sample 2 of 2 in ${samp} with EM\"; ./bin/salmon quant -i transcriptome/human_index -l IU -1 ${fn}/${samp}/sample_02_1_shuffled.fa.gz -2 ${fn}/${samp}/sample_02_2_shuffled.fa.gz -p 6 --gcBias --useBoth --validateMappings -o quants/${samp}_02_quant_both"&
